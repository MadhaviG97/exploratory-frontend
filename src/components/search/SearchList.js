...
import ProjectItem from '../Feed/ProjectItem'
...
function TabPanel(props: TabPanelProps) {
  ...
  return (
    ...
    { props.projects?
      ...
      ):<div alignItems="center" style={{textAlign:"center", backgroundColor:"#b2beb5",marginBottom:'10px'}}>No Projects</div>            
    ):null
        }
   
    {
      props.researchers ? (
        ...
        ): <div alignItems="center" style={{textAlign:"center", backgroundColor:"#b2beb5",marginBottom:'10px'}}>No Researchers</div> 
...

    {
      props.institutions ? (
        ...
        ): <div alignItems="center" style={{textAlign:"center", backgroundColor:"#b2beb5",marginBottom:'10px'}}>No Institutions</div> 
...
const SearchList = (props) => {
  ...
  <Paper className={classes.root}>
      ...
      <TabPanel value={value} index={0} projects={props.projects}>
     
      </TabPanel>
      <TabPanel value={value} index={1} researchers={props.researchers} >
       
      </TabPanel>
      <TabPanel value={value} index={2} institutions={props.institutions}>
