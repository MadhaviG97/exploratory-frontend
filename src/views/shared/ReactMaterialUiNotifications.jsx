...
class Notification extends Component {
      ...
      if (this.props.personalised) {
        ...
        iconEl = (
          <div style={leftIconBodyStyle}>
            <Avatar src={this.props.avatar} size={44} style={leftAvatarStyle} />
  ...
  render() {
    ...
    if (this.props.additionalText) {
      secondaryText = (
        <div style={secondaryTextStyle}>{this.props.additionalText}</div>
      );
    }
    /**
    ...
    if (this.props.overflowContent) {
      expandedAction = (
        <span>
          <Divider inset={true} />
          <div style={overflowContentStyle}>{this.props.overflowContent}</div>
        </span>
      );
    } else {
    ...
    return (
      <CSSTransitionGroup
        transitionName={
          this.props.transitionName ? this.props.transitionName : ""
        }
        transitionAppear={
          this.props.transitionAppear ? this.props.transitionAppear : false
        }
        transitionEnter={
          this.props.transitionEnter ? this.props.transitionEnter : false
        }
        transitionLeave={
          this.props.transitionLeave ? this.props.transitionLeave : false
        }
